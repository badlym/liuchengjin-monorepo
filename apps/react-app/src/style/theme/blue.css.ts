...
export const colorConfig: themeVarsType = {
  ...
  /** 强调按钮不可用状态下的背景颜色 */
  btnPrimaryDisableBg: '#94BBFF',
  /** 强调按钮鼠标hover和按下时背景颜色 */
  btnPrimaryHoverBg: '#2968E6',
  ...
  menuCheckedColor: '#E5EEFF',
  menuCheckedTextColor: '#2C6FF5',
